<template>
  <section class="bg-white shadow rounded p-5 flex items-stretch mb-5">
    <UiImage :src="item.cover" class="w-[108px] h-[138px] rounded flex-shrink-0 bg-gray-50"></UiImage>
    <div class="flex flex-col pl-5 flex-1">
        ...
        <div class="mt-auto flex items-center">
            ...
            <n-button @click="open" class="ml-auto" strong secondary round type="primary" size="medium">
